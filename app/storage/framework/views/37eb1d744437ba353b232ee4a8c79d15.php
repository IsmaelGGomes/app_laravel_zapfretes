                ...
                <div>
                    <div class="relative">
                        ...
                        <input name="nome" type="text" value="<?php echo e(old('nome')); ?>"
                            class="<?php echo e($errors->first('nome') ? 'w-full rounded-lg border-2 border-red-500 p-4 text-sm shadow-md' : 'w-full rounded-lg  p-4 pe-12 border-none text-sm shadow-md'); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <div class="relative">
                        ...
                        <input id="telefone_format" minlength="2" value="<?php echo e(old('numero')); ?>" maxlength="14" name="numero" type="text"
                            class="<?php echo e($errors->first('numero') ? 'w-full rounded-lg border-2 border-red-500 p-4 text-sm shadow-md' : 'w-full rounded-lg  p-4 pe-12 border-none text-sm shadow-md'); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <div class="relative">
                        ...
                        <input name="transportadora" type="text" value="<?php echo e(old('transportadora')); ?>"
                            class="<?php echo e($errors->first('transportadora') ? 'w-full rounded-lg bg-white border-2 border-red-500 p-4 text-sm shadow-md' : 'w-full rounded-lg  p-4 pe-12 border-none text-sm shadow-md'); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <div class="relative">
                        ...
                        <input name="filial" type="text" value="<?php echo e(old('filial')); ?>"
                            class="<?php echo e($errors->first('filial') ? 'w-full rounded-lg border-2 border-red-500 p-4 text-sm shadow-md' : 'w-full rounded-lg border-none p-4 pe-12 text-sm shadow-md'); ?>"
